        ...
        public ExamsController(ExamContext context)
        {
            ...
            if (_context.ExamItems.Count() == 0)
            {
                _context.ExamItems.Add(new Exam { 
                    professor = "Signorile Chiara" ,
                    code = "23ACIPL",
                    title = "Analisi complessa ed e lementi di statistica (AA-ZZ)",
                    location = "Bari - LAIB5 - Lab. Inf. di Base - Corso Duca",
                    date = "08/02/2018",
                    deadLineSubscription = "31/01/2018",
                    type = "scritto"});
                _context.ExamItems.Add(new Exam { 
                    professor = "Capozzi Davide" ,
                    code = "02NNDLX",
                    title = "Analisi Matematica II",
                    location = "Bari - 1B - AULA Corso Duca",
                    date = "08/02/2018",
                    deadLineSubscription = "06/02/2018",
                    type = "scritto"});
                _context.ExamItems.Add(new Exam { 
                    professor = "Capozzi Andrea" ,
                    code = "01ANXLD",
                    title = "Analisi Matematica I",
                    location = "Bari - 1A - AULA Corso Settembrini",
                    date = "08/02/2018",
                    deadLineSubscription = "06/02/2018",
                    type = "scritto"});
